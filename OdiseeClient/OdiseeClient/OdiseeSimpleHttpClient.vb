...
Namespace Http
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class OdiseeSimpleHttpClient
...
#Region "Odisee Request API methods"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function mergeDocumentAtEnd(ByRef requestElement As XmlElement, ByVal filepath As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function mergeDocumentAtEnd(ByVal filepath As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function executeMacro(ByRef requestElement As XmlElement, ByVal macroName As String, ByVal location As String, ByVal language As String, ByVal parameters As List(Of String)) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function executeMacro(ByVal macroName As String, ByVal location As String, ByVal language As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function executeBasicMacroInDocument(ByRef requestElement As XmlElement, ByVal macroName As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function executeBasicMacroInDocument(ByVal macroName As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setTableCellValue(ByRef requestElement As XmlElement, ByVal tableName As String, ByVal coordinate As String, ByVal cellValue As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setTableCellValue(ByVal tableName As String, ByVal coordinate As String, ByVal cellValue As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setUserfield(ByRef requestElement As XmlElement, ByVal userfieldName As String, ByVal userfieldValue As String) As OdiseeSimpleHttpClient
            Dim xmlElement As XmlElement = __xmlDoc.CreateElement("userfield")
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setUserfield(ByVal userfieldName As String, ByVal userfieldValue As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setArchive(ByRef requestElement As XmlElement, ByVal archiveToDatabase As Boolean, ByVal archiveToFilesystem As Boolean) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setArchive(ByVal archiveToDatabase As Boolean, ByVal archiveToFilesystem As Boolean) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setLatestTemplate(ByRef requestElement As XmlElement, ByVal template As String, ByVal outputFormat As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setLatestTemplate(ByVal template As String, ByVal outputFormat As String) As OdiseeSimpleHttpClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Function createRequest() As OdiseeSimpleHttpClient
            ' <request>
