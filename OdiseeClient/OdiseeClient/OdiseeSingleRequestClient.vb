...
Namespace Http
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class OdiseeSingleRequestClient
...
#Region "Odisee Client Factory Methods"
        ...
        '
        Public Shared Function createClient(ByVal serviceURL As String) As OdiseeSingleRequestClient
            Dim odiseeClient As OdiseeSingleRequestClient = New OdiseeSingleRequestClient()
            ' Set service URL
        ...
        ' Factory method for creating a Odisee XML client.
        '
        Public Shared Function createClient(ByVal serviceURL As String, ByVal authKey As String) As OdiseeSingleRequestClient
            Dim odiseeClient As OdiseeSingleRequestClient = New OdiseeSingleRequestClient()
            ' Set service URL
            odiseeClient.serviceURL = serviceURL
            ' Set authkey
        ...
        ' Factory method for creating a Odisee XML client.
        '
        Public Shared Function createClient(ByVal serviceURL As String, ByVal username As String, ByVal password As String) As OdiseeSingleRequestClient
            Dim odiseeClient As OdiseeSingleRequestClient = New OdiseeSingleRequestClient()
            ' Set service URL
            odiseeClient.serviceURL = serviceURL
...
#Region "Odisee Request API Methods"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function mergeDocumentAtEnd(ByVal filepath As String) As OdiseeSingleRequestClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function executeMacro(ByVal macroName As String, ByVal location As String, ByVal language As String, ByVal parameters As List(Of String)) As OdiseeSingleRequestClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function executeBasicMacroInDocument(ByVal macroName As String) As OdiseeSingleRequestClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setTableCellValue(ByVal tableName As String, ByVal coordinate As String, ByVal cellValue As String) As OdiseeSingleRequestClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setUserfield(ByVal userfieldName As String, ByVal userfieldValue As String) As OdiseeSingleRequestClient
            Dim xmlElement As XmlElement = __xmlDoc.CreateElement("userfield")
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setArchive(ByVal archiveToDatabase As Boolean, ByVal archiveToFilesystem As Boolean) As OdiseeSingleRequestClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function setLatestTemplate(ByVal template As String, ByVal outputFormat As String) As OdiseeSingleRequestClient
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Function createRequest() As OdiseeSingleRequestClient
            ' <request>
